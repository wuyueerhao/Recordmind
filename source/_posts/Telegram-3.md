---
title: Telegram账号一定要做的三个设置！
date: 2023-11-28 18:06:44
tags: [Telegram]
categories:
	- 笔记
---
...
![tele](https://raw.githubusercontent.com/wuyueerhao/upimage/master/tele.gif)

<font color="red">**关于手机号码**</font>

- 有条件的，尽量不要使用【+86】的号码，使用Google Voice或国外号码来注册，最好使用虚拟号
- 无条件的，若不得不要用【+86】的号码，尽量要开启上面的设置

#### 2.关闭文件自动下载

这样如果别人给你发送可疑文件或者包含病毒木马的文件就不会自动下载到电脑上了。

这个非常关键，很多人的电脑就是这一步没有设置好而中了病毒木马导致设备出现问题。

在 设置  ---> 数据和存储 ---> 自动下载媒体 里关闭文件的自动下载

Settings  --> Data  and Storage  --> AUTOMATIC MEDIA DOWNLOAD

![tele2](https://raw.githubusercontent.com/wuyueerhao/upimage/master/tele2.gif)
...
![image-20231125170410602](https://raw.githubusercontent.com/wuyueerhao/upimage/master/image-20231125170410602.png)
